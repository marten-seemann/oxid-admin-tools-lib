...
/**
* format a SQL query in a nice, human-readable format
*
* introduces line breaks, highlights SQL keywords etc.
*
* @link http://stackoverflow.com/questions/2078661/use-php-to-format-an-input-sql-query-as-html
* @param string $sql_raw the SQL query
